...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"styles/main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
card.style.boxShadow = '0rem 0rem 2rem 2rem rgba(0,0,0,0.1)';
...
var CountDown = /*#__PURE__*/function () {
  function CountDown(selector, endDate) {
    ...
    this.endDate = (0, _moment.default)(endDate); // the endDate as a date object

    this.now = (0, _moment.default)(); // this is the current date and time as a date object
  ...
  _createClass(CountDown, [{
    ...
    value: function updateTime() {
      ...
      setInterval(function () {
        ...
        _this.duration = _moment.default.duration(_this.duration - _this.updateInterval);
        _this.time.days = _this.duration.days() + _this.duration.years() * 365;
        _this.time.hours = _this.duration.hours();
        _this.time.minutes = _this.duration.minutes();
        _this.time.seconds = _this.duration.seconds();
    ...
    value: function createHtml() {
      return "\n        <div> \n        <p> ".concat(this.time.days, " Days  </p>\n        <p>").concat(this.time.hours, " Hours  </p>\n        <p> ").concat(this.time.minutes, " Minutes  </p>\n        <p> ").concat(this.time.seconds, " Seconds  </p>        \n        </div>\n        \n        ");
    }
  }, {
    key: "render",
    value: function render() {
      var output = document.querySelector(this.selector);
      output.innerHTML = this.createHtml();
    }
  }]);

  return CountDown;
}(); //! #output is here the id = "output" from the div inside of the index.html !


var result = new CountDown('#output', {
  year: '2021',
  month: '11',
  day: '12',
  hour: '10'
...
console.log(result);
},{"bootstrap/dist/css/bootstrap.min.css":"../node_modules/bootstrap/dist/css/bootstrap.min.css","bootstrap":"../node_modules/bootstrap/dist/js/bootstrap.esm.js","../styles/main.scss":"styles/main.scss","moment":"../node_modules/moment/moment.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
